...
clearvars -except Patient1ECoG Patient1Glove Patient1Test Patient1Channel Patient1Fingers Patient1ChannelTest f sub1test_dg sub2test_dg sub3test_dg

%Step 1
%Input Parameters
Channel=Patient1ChannelTest;
NumberofChannels=64;
ECoGLength=200000;
WindowLength=150;
Frequency=1000;
...
%cubic interpolation
PPpatient1=spline(Dataposition1,Positionpredict3,Expandedposition);
sub3test_dg=PPpatient1';
