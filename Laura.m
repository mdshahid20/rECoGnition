%could be concern: magnitude of fourier transform,
%should first column of feature matrix be ones?, you averaged over position
%rather than just down sampling, constraining endpoints on spline?,
...
Dataposition=(WindowLength/2:WindowDisplacement:last);
...
rvalueontrainingpatient1=mean(correlation)
